...
var getProductsListRequest = (url) => {
  return new Promise(function(resolve, reject) {
    let getProductListRequest = axios_default.get(
      url
    );
...
var getProductByIdRequest = (productId) => {
  return new Promise(function(resolve, reject) {
    let getProductByIdRequest2 = axios_default.get(
      serverUrl + "1a1fb542-22d1-4919-914a-750114879775?code=" + productId
    );
    getProductByIdRequest2.then(function(result) {
      resolve(result.data);
    }, function(error) {
      reject(error.response);
    });
